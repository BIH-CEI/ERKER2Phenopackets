from .MappingDicts import sex_map_erker2phenopackets, zygosity_map_erker2phenopackets, age_range_map_erker2phenopackets
...
from src.utils.Phenopackets2JSON import write_phenopacket2json_file as write_phenopackets, \
